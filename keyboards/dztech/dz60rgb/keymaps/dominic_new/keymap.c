...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    |--------------------------------------------------------------------------------------------------------------------------------------|
    |                   |        |        |        |        |        |        |        | <      | >      |         ?     |        |  Del   |
    | Shift             | Z      | X      | C      | V      | B      | N      | M      | ,      | .      | Shft    /     | Up     |   2    |
    |--------------------------------------------------------------------------------------------------------------------------------------|
    |          |          |          |                                                        |          |      |        |        |        |
    | Ctrl     | Win      | Alt      | Space                                                  | Alt      |  1   | Left   | Down   | Right  |
    '--------------------------------------------------------------------------------------------------------------------------------------'
  */
	...
	[_FUNCTION] = LAYOUT(
		...
		KC_TRNS, KC_TRNS, KC_UP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_INS, KC_TRNS, KC_MPRV, KC_VOLU, KC_MNXT, RESET,\
		KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS, KC_PSCR, KC_SLCK, KC_PAUS, KC_MUTE, KC_VOLD, KC_TRNS,\
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_END, KC_RSFT, KC_PGUP, KC_CALC,\
		KC_TRNS, KC_TRNS, KC_TRNS, TO(4), KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, KC_END),
	[_RGB] = LAYOUT(
